...
public class DeleteOperation<T> {
	...
	private boolean deleteNodeAtBegin(SinglyLinkedList<T> objList) {
	...
	private boolean deleteNodeAtEnd(SinglyLinkedList<T> objList) {
		if(objList.objHead == null) {
			System.out.println("List is empty");
			return false;
		}
	...
	private boolean deleteNodeAtPosition(SinglyLinkedList<T> objList,int jPosition) {
		if(jPosition < 0)
			jPosition = 0 ;
	...
	public void deleteNode(SinglyLinkedList<T> objList)throws NumberFormatException,IOException{
